...
public class home_data extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView l =(ListView) findViewById(R.id.list_home_table_all);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.home_data, menu);
        return true;
    }
